// Made by ertugrulozcan
// https://github.com/ertugrulozcan/
// https://gist.github.com/ertugrulozcan/f663d68764dc9c09e169
...
$(document).mousemove(function(event) {
    ...
    $('#pres').css('-webkit-transform','rotate3d(' + -tiltx + ', ' + -tilty + ', 0, ' + degree + 'deg)');
    $('#pres').css('transform','rotate3d(' + -tiltx + ', ' + -tilty + ', 0, ' + degree + 'deg)');
